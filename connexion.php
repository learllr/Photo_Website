...
if( (isset($_POST['connexion'])) && ($_POST['connexion'] = 'Connexion') )
{
  ...
  if ( (isset($_POST['idf']) && !empty($_POST['idf'])) && (isset($_POST['mdp']) && !empty($_POST['mdp'])))
  {
    ...
    if (utilisateurExiste($pseudo, $mdp, $bdd) == 1)
    {
      ...
      // On vérifie que le membre est un utilisateur.
      ...
      // Si le membre est un administrateur, il n'est pas dans le bon espace.
      else if($rep['statut'] == "admin")
      {
        $msg = "Pour vous connecter à l'espace administrateur, veuillez cliquer sur le bouton rouge en haut à droite !";
...
<!-- Formulaire de connexion de l'espace administrateur qui demande un identifiant et un mot de passe -->
<div style="position: absolute; right: 100px; top: 88px; color: white;">
<a href="connexionAdmin.php" role="button" class="btn btn-danger">Espace administrateur</button> </a>
</div>
<div class = "body" >
<body class="text-center">  
<main class="form-signin" style="position: relative; top: -100px;">
  <form method="post" action="connexion.php">	
  <h1 class="h3 mb-3 fw-normal"> Veuillez vous connecter à l'espace utilisateur</h1>
